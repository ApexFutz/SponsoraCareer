...
async function handleSignIn(event, userType) {
    ...
    try {
        ...
        showAuthError(form, error.message || 'Invalid email or password. Please try again.');
...
function showSuccessMessage(userType, email, remember) {
    ...
    // Show brief success message then redirect to dashboard
...
function showSignUp(userType) {
    // Redirect to registration page with user type parameter
